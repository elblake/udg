...
An Erlang preprocessor to provide a mechanism for user defined guards and pattern templates, facilitating reusable and composable pattern and guard bundles, written in pure Erlang.
...
A pattern template's definition goes by a variation of the user defined guard's syntax:
...
To facilitate cross module reuse, a new separate source file is used with the extension .erg to contain the user defined guard and pattern template definitions.
